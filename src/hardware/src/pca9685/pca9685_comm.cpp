...
// PCA9685::PCA9685(std::shared_ptr<hardware::I2CBusManager> i2c_bus, int device_address)
//     : i2c_dev(std::move(i2c_bus)), address(device_address) {}
...
//     if (i2c_dev) {
//       set_all_pwm(0, 0);
//       // i2c_bus.reset();  // Releases the unique_ptr and closes the connection
//     }
// }
...
//   // i2c_bus->ConnectToPeripheral(address);
